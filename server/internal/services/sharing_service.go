...
func (s *SharingService) GetShortMetadata(short *models.Template) map[string]string {
	return map[string]string{
		...
		"og:image":       fmt.Sprintf("https://img.youtube.com/vi/%s/maxresdefault.jpg", short.YoutubeID),
...
func (s *SharingService) GetTemplateMetadata(template *models.Template) map[string]string {
	return map[string]string{
		...
		"og:image":       fmt.Sprintf("https://img.youtube.com/vi/%s/maxresdefault.jpg", template.YoutubeID),
